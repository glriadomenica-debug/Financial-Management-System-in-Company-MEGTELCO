...
<div class="container mt-4">
    ...
    <div class="d-flex align-items-center gap-2 mb-3">
        <a href="{{ route('likidasaun_instalasaun.aumentaLikInstall') }}" class="btn btn-success">➕ AUMENTA DADUS LIKIDASAUN</a>
        {{-- <button class="btn btn-primary">📄 PRINT PDF</button>
        <button class="btn btn-primary">📄 PRINT EXCEL</button> --}}
        <a href="{{ route('likidasaun_instalasaun.report') }}" class="btn btn-info">PRINT RELATORIU</a>
    ...
    {{-- <div class="table-responsive" style="overflow-x: auto; border: 1px solid #dee2e6; border-radius: 5px; padding: 10px;">
        <table class="table table-bordered"> --}}
            ...
            <tbody>
                ...
                @foreach ($likidasauns_instalasaun as $likidasaun)
                    @php
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('likidasaun_instalasaun.edit', $likidasaun->id) }}" class="btn btn-sm btn-info">Edit</a>
                            <form action="{{ route('likidasaun_instalasaun.destroy', $likidasaun->id) }}" method="POST" style="display: inline-block;">
                                @csrf
                                @method('DELETE')
