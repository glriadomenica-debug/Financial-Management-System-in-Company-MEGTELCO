        ...
        <div class="card-body">
            <div id="export-only" style="display: none;">
                <div class="export-header">
                    <div style="display: flex; align-items: center; margin-bottom: 15px;">
                        ...
                        <div>
                            ...
                            <p style="margin: 0; font-size: 9pt;">Relatoriu Komparasaun Likidasaun Instalasaun</p>
                        </div>
                    </div>
                ...
                <table style="width: 100%; margin-bottom: 15px; border-collapse: collapse;">
                    <thead>
                        <tr>
                            <th style="border: 1px solid #ddd; padding: 6px; background-color: #f5f5f5; text-align: left;" colspan="2">Total Likidasaun Instalasaun</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <td style="border: 1px solid #ddd; padding: 6px; text-align: left; width: 50%;">
                            ...
                            <td style="border: 1px solid #ddd; padding: 6px; text-align: right; width: 50%;">${{ number_format($currentTotal, 2, ',', '.') }}</td>
                        </tr>
                        <tr>
                ...
                <table style="width: 100%; margin-bottom: 15px; border-collapse: collapse;">
                    <thead>
                        <tr>
                            <th style="border: 1px solid #ddd; padding: 6px; background-color: #f5f5f5; text-align: left; width: 40%;">Metodu Pagamentu</th>
                            <th style="border: 1px solid #ddd; padding: 6px; background-color: #f5f5f5; text-align: right; width: 30%;">
                                @if($reportType == 'year_comparison')
                                    Tinan {{ $currentYear }}
                                @else
                                    {{ $month }} {{ $year }}
                ...
                <table style="width: 100%; margin-bottom: 20px; border-collapse: collapse; font-size: 9pt;">
                    <thead>
                        <tr>
                            <th style="border: 1px solid #ddd; padding: 6px; background-color: #f5f5f5; text-align: left; width: 15%;">Data</th>
                            <th style="border: 1px solid #ddd; padding: 6px; background-color: #f5f5f5; text-align: left; width: 20%;">Naran</th>
                            <th style="border: 1px solid #ddd; padding: 6px; background-color: #f5f5f5; text-align: left; width: 25%;">Deskrisaun</th>
                            <th style="border: 1px solid #ddd; padding: 6px; background-color: #f5f5f5; text-align: left; width: 20%;">Metodu Pagamentu</th>
                            <th style="border: 1px solid #ddd; padding: 6px; background-color: #f5f5f5; text-align: right; width: 20%;">Montante ($)</th>
                        </tr>
                    </thead>
                    <tbody>
                        @php
                        ...
                        @endphp
                        <tr>
                            <td style="border: 1px solid #ddd; padding: 6px; text-align: left;">{{ date('d/m/Y', strtotime($likidasaun->data)) }}</td>
                    ...
                    <tfoot>
                        <tr style="font-weight: bold;">
                            ...
                            <td style="border: 1px solid #ddd; padding: 6px; text-align: right;">${{ number_format($currentPeriodTotal, 2, ',', '.') }}</td>
                        </tr>
                    </tfoot>
                </table>

                <!-- Komparasaun tinan/fulan -->
                <h5 style="margin: 15px 0 10px 0; font-size: 11pt; font-weight: bold;">
                    Detallu Likidasaun Instalasaun 
                    @if($reportType == 'year_comparison')
                        Tinan {{ $comparisonYear }}
                ...
                <table style="width: 100%; margin-bottom: 20px; border-collapse: collapse; font-size: 9pt;">
                    ...
                    <tfoot>
                        <tr style="font-weight: bold;">
                            <td style="border: 1px solid #ddd; padding: 6px; text-align: center;" colspan="4">Total</td>
                            <td style="border: 1px solid #ddd; padding: 6px; text-align: right;">${{ number_format($comparisonPeriodTotal, 2, ',', '.') }}</td>
                        </tr>
                    </tfoot>
                </table>
                
                <div style="margin-top: 30px; padding-top: 10px; border-top: 1px solid #ddd; font-size: 9pt; text-align: center;">
                    <p>Sistema Jestaun Finanseiru</p>
                    <p>© {{ date('Y') }} - MEGTELCO S.A</p>
                </div>
            </div>
                    ...
                    <table class="table table-bordered table-sm">
                        ...
                        <tbody>
                            ...
                            @foreach($allMethods as $method)
                                ...
                                <tr>
                                    <td>{{ $method['naran'] }}</td>
                                    <td style="text-align: right;">${{ number_format($currentMethodTotal, 2, ',', '.') }}</td>
                                    <td style="text-align: right;">${{ number_format($comparisonMethodTotal, 2, ',', '.') }}</td>
                                </tr>
                            @endforeach
                        </tbody>
                        <tfoot class="font-weight-bold">
                            <tr>
                                <td>Total</td>
                                <td style="text-align: right;">${{ number_format($currentPaymentTotal, 2, ',', '.') }}</td>
                                <td style="text-align: right;">${{ number_format($comparisonPaymentTotal, 2, ',', '.') }}</td>
                            </tr>
                        </tfoot>
                    </table>
                </div>
                    ...
                    <table class="table table-bordered table-sm table-hover">
                        <thead class="thead-dark">
                            <tr>
                                ...
                                <th style="width: 25%;">Deskrisaun</th>
                                <th style="width: 20%;">Metodu Pagamentu</th>
                        ...
                        <tbody>
                            ...
                            @endphp
                            <tr>
                                <td>{{ date('d/m/Y', strtotime($likidasaun->data)) }}</td>
                        ...
                        <tfoot class="font-weight-bold">
                            <tr>
                                ...
                                <td style="text-align: right;">${{ number_format($currentPeriodTotal, 2, ',', '.') }}</td>
                            </tr>
                        </tfoot>
                    </table>
                </div>
                ...
                <div class="table-responsive mb-4">
                    <table class="table table-bordered table-sm table-hover">
                        ...
                        <tfoot class="font-weight-bold">
                            <tr>
                                <td colspan="4" class="text-center">Total</td>
                                <td style="text-align: right;">${{ number_format($comparisonPeriodTotal, 2, ',', '.') }}</td>
                            </tr>
                        </tfoot>
                    </table>
                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    document.getElementById('generate-pdf').addEventListener('click', function() {
        ...
        html2canvas(element, {
            ...
            let fileName = `Relatoriu_Komparasaun_Likidasaun_Instalasaun_`;
            if(reportType == 'year_comparison') {
